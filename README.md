...
1. [Bash](#bash)
    ...
    2. [Récupérer le nombre de paramètres](#récupérer-le-nombre-de-paramètres-en-bash)
    3. [Récupérer les paramètres](#récupérer-les-paramètres-en-bash)
    4. [Connaître la taille d'une chaine de caractères](#connaître-la-taille-dune-chaîne-de-caractères-en-bash)
    5. [Boucles](#boucles-en-bash)
        1. [if else](#if-else-en-bash)
        2. [for](#for-en-bash)
    6. [Incrémenter une variable](#incrémenter-une-variable-en-bash)
    7. [Opérations mathématiques](#opérations-mathématiques-en-bash)
    8. [Vérifier si une chaîne est contenue dans une autre](#vérifier-si-une-chaîne-est-contenue-dans-une-autre-en-bash)
    9. [Lowercase/Uppercase](#lowercaseuppercase-en-bash)
    10. [Enlever un caractère d'une chaîne](#enlever-un-caractère-dune-chaîne-en-bash)
    11. [Concaténer deux chaînes de caractères](#concaténer-deux-chaînes-de-caractères-en-bash)
    12. [Comparer deux chaînes de caractères](#comparer-deux-chaînes-de-caractères-en-bash)
    13. [Comparer deux entiers](#comparer-deux-entiers-en-bash)
    14. [Récupérer la position d'une sous-chaîne dans une chaîne](#récupérer-la-position-dune-sous-chaîne-dans-une-chaîne-en-bash)
2. [C++](#c++)
    1. [Structure d'un fichier C++](#structure-dun-fichier-c++)
    2. [Récupérer le nombre de paramètres](#récupérer-le-nombre-de-paramètres-en-C++)
    3. [Récupérer les paramètres](#récupérer-les-paramètres-en-C++)
    4. [Connaître la taille d'une chaine de caractères](#connaître-la-taille-dune-chaîne-de-caractères-en-C++)
    5. [Boucles](#boucles-en-C++)
        1. [if else](#if-else-en-C++)
        2. [for](#for-en-C++)
    6. [Incrémenter une variable](#incrémenter-une-variable-en-C++)
    7. [Opérations mathématiques](#opérations-mathématiques-en-C++)
    8. [Vérifier si une chaîne est contenue dans une autre](#vérifier-si-une-chaîne-est-contenue-dans-une-autre-en-C++)
    9. [Lowercase/Uppercase](#lowercaseuppercase-en-C++)
    10. [Enlever un caractère d'une chaîne](#enlever-un-caractère-dune-chaîne-en-C++)
    11. [Concaténer deux chaînes de caractères](#concaténer-deux-chaînes-de-caractères-en-C++)
    12. [Comparer deux chaînes de caractères](#comparer-deux-chaînes-de-caractères-en-C++)
    13. [Comparer deux entiers](#comparer-deux-entiers-en-C++)
    14. [Récupérer la position d'une sous-chaîne dans une chaîne](#récupérer-la-position-dune-sous-chaîne-dans-une-chaîne-en-C++)
3. [Python](#python)
    1. [Structure d'un fichier Python](#structure-dun-fichier-python)
    2. [Récupérer le nombre de paramètres](#récupérer-le-nombre-de-paramètres-en-Python)
    3. [Récupérer les paramètres](#récupérer-les-paramètres-en-Python)
    4. [Connaître la taille d'une chaine de caractères](#connaître-la-taille-dune-chaîne-de-caractères-en-Python)
    5. [Boucles](#boucles-en-Python)
        1. [if else](#if-else-en-Python)
        2. [for](#for-en-Python)
    6. [Incrémenter une variable](#incrémenter-une-variable-en-Python)
    7. [Opérations mathématiques](#opérations-mathématiques-en-Python)
    8. [Vérifier si une chaîne est contenue dans une autre](#vérifier-si-une-chaîne-est-contenue-dans-une-autre-en-Python)
    9. [Lowercase/Uppercase](#lowercaseuppercase-en-Python)
    10. [Enlever un caractère d'une chaîne](#enlever-un-caractère-dune-chaîne-en-Python)
    11. [Concaténer deux chaînes de caractères](#concaténer-deux-chaînes-de-caractères-en-Python)
    12. [Comparer deux chaînes de caractères](#comparer-deux-chaînes-de-caractères-en-Python)
    13. [Comparer deux entiers](#comparer-deux-entiers-en-Python)
    14. [Récupérer la position d'une sous-chaîne dans une chaîne](#récupérer-la-position-dune-sous-chaîne-dans-une-chaîne-en-Python)
